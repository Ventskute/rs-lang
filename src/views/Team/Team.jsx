...
const team = [
  {
    ...
    position: "Mentor",
    work: "Наставничество. Координация и мотивация команды. Проверка качества кода и приложения.",
  ...
  },
  {
    ...
    position: "Team Lead",
    work: "Реализовала игру Филворд, меню, список слов, фулскрин в играх, оформила дизайн всего приложения.",
  ...
  },
  {
    ...
    work: "Реализовала игру Саванна, страницу статистики, страницу команды, растущего питомца Жирафика.",
  ...
  },
  {
    ...
    position: "Software engineer",
    work: "Реализовал игру Спринт, сверстал главную страницу, страницу электронного учебника.",
  ...
  },
  {
    ...
    position: "Software engineer",
    work: "Реализовал игру Аудиовызов, сделал и связал с приложением бэкенд, создал словарь, исправил кучи багов.",
